...
import static org.bricks.utils.EntityUtils.getComponentClass;
import static org.bricks.utils.EntityUtils.getComponentClassList;
...
import static org.bricks.utils.EntityUtils.getEnumValue;
...
public class EntityUtilsTest
{
    ...
    {
        StringBuilder builder = new StringBuilder();
        buildString(builder, newArrayList(newArrayList(1)));
    ...
    @Getter
    @AllArgsConstructor
    private enum Color implements ValueEnum<Integer>
    {
