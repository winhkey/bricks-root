...
public class FunctionUtils {
     ...
     * @return consumer
     */
    public static <T> Consumer<T> accept(ThrowableConsumer<T, Throwable> throwableConsumer, Consumer<T> catchConsumer, Logger logger, Function<Throwable, RuntimeException> exceptionFunction) {
        return t -> {
            try {
     ...
     * @return Supplier
     */
    public static <T> Supplier<T> get(ThrowableSupplier<T, Throwable> throwableSupplier, Logger logger, Function<Throwable, RuntimeException> exceptionFunction) {
        return () -> {
            T t = null;
            try {
     ...
     * @return Predicate
     */
    public static <T> Predicate<T> test(ThrowablePredicate<T, Throwable> throwablePredicate, Logger logger, Function<Throwable, RuntimeException> exceptionFunction) {
        return t -> {
     ...
     * @return Function
     */
    public static <T, R> Function<T, R> apply(ThrowableFunction<T, R, Throwable> throwableFunction, Function<T, R> catchFunction, Logger logger, Function<Throwable, RuntimeException> exceptionFunction) {
        return t -> {
            R r;
            try {
